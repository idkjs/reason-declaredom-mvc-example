...
//   <span> <text> {string_of_int(counter)} </text> </span>;

// // let counter =(~children as _, ()) => store |> map({counter} => children(counterEl(counter))) |> CallbagElement.make;
// // let counter = (~children as _, ()) =>{
// //   store
// //   |> map(({counter})=>counterEl(counter))
// // //   => {
// //     //   counterEl(counter)
// //     //   children=<span>
